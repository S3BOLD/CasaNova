...
// ---------------------------------------------------------------------
// REFERÊNCIAS — adicione aqui as fotos de referência para os presentes.
// Essa lista NÃO aparece editável no site: só quem mexe no código (você)
// consegue adicionar, trocar ou remover itens daqui.
//
// Duas formas de usar uma imagem:
//
// 1) Imagem local: coloque o arquivo dentro da pasta "public/referencias/"
//    (crie a pasta se não existir) e aponte o caminho começando com "/",
//    por exemplo: "/referencias/toalha-banho.jpg"
//
// 2) Imagem da internet: cole a URL direta da imagem (terminando em
//    .jpg, .png, .webp etc).
//
// "caption" é o texto que aparece embaixo da foto (opcional).
// ---------------------------------------------------------------------
export const REFERENCE_IMAGES = [
  ...
  },
  {
    ...
    caption: 'Abridor de Latas e Garrafas'
  },
  {
    ...
    caption: 'Kit Frigideiras Antiaderentes'
  },
  {
  ...
  },
  {
    ...
    caption: 'Porta Guardanapos e Papel Toalha'
  },
  {
  ...
  },
  {
    ...
    caption: 'Jogo de Copos Graffiato '
  },
  {
  ...
  {
    src:'https://http2.mlstatic.com/D_NQ_NP_2X_789324-MLA82919264927_032025-F-cortador-fatiador-legumes-profissional-triturador-lamina-aco.webp',
    link:'https://www.mercadolivre.com.br/cortador-fatiador-legumes-profissional-triturador-lamina-aco/up/MLBU3056478870?pdp_filters=item_id%3AMLB3995396761&matt_tool=38524122#origin=share&sid=share&wid=MLB3995396761&action=copy',
    caption:'Ralador'
  },
  {
  ...
  },
  {
    ...
    link:'https://a.co/d/0gUayLY9',
    caption:'Jogo de Xicaras'
  },
  {
    src:'https://m.media-amazon.com/images/I/61mDXbMLe4L._AC_SX679_.jpg',
    link:'https://m.media-amazon.com/images/I/61mDXbMLe4L._AC_SX679_.jpg',
